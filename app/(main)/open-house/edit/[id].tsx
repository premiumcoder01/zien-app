...
import { extractPropertyBaths, extractPropertyBeds, extractPropertySqft, formatPropertyPrice, getAllPropertyImages, RawPropertyItem, uploadPropertyImage } from '@/services/propertyService';
...
function getStyles(colors: any) {
  return StyleSheet.create({
    ...
    phoneDescLabel: { fontSize: 10, fontWeight: '800', color: '#0F172A', letterSpacing: 0.5, marginTop: 4, marginBottom: 6 },
    phoneDescText: { fontSize: 11, fontWeight: '400', color: '#64748B', lineHeight: 16 },
    phoneDivider: { height: 1, backgroundColor: '#F1F5F9', marginVertical: 14 },
    phoneFooterRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
    phoneAgentBox: { flexDirection: 'row', alignItems: 'center', flex: 1, marginRight: 10 },
    phoneAgentAvatar: { width: 32, height: 32, borderRadius: 16, backgroundColor: '#F0FDFA', alignItems: 'center', justifyContent: 'center', marginRight: 8 },
    phoneAgentInfo: { flex: 1 },
    phoneAgentName: { fontSize: 12, fontWeight: '700', color: '#0F172A' },
    phoneAgentSub: { fontSize: 10, fontWeight: '500', color: '#94A3B8' },
    phoneQrBox: { width: 36, height: 36, borderRadius: 8, borderWidth: 1, borderColor: '#E2E8F0', alignItems: 'center', justifyContent: 'center', backgroundColor: '#FAFAFA' },
